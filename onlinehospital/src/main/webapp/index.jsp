	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="image/doc1.jpg" width="200px" height="300px">
						<p class="fw-bold fs-5">Mohamed manai</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="image/doc2.jpg" width="200px" height="300px">
						<p class="fw-bold fs-5">Dr.amen nasri</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="image/doc3.jpg" width="200px" height="300px">
						<p class="fw-bold fs-5">Imen gammoudi</p>
						<p class="fs-7">(Nurse)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="image/doc4.jpg" width="200px" height="300px">
						<p class="fw-bold fs-5">Ahlem jouini</p>
						<p class="fs-7">(Medical Advisor)</p>
					</div>
				</div>
			</div>
