	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="image/rendez_vous.jpg" width="400" height="500">
			</div>
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form class="row g-3" action="addappointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputPassword4" class="form-label">Speciality</label> <select
									required class="form-control" name="spec">
